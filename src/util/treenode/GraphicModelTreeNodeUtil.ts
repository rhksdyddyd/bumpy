import GraphicModel, { GraphicTypeEnum } from 'node/Graphic/GraphicModel';
import { isGraphicModel } from 'util/treenode/TreeNodeTypeGuards';
 ...
 */
function collectChildGraphicModelRecursively(parent: GraphicModel, childGraphicModelList: Array<GraphicModel>) {
 ...
 */
export function getAncestorsList(graphicModel: GraphicModel, startFromRootGroup: boolean): Array<GraphicModel> {
