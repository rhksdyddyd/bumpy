...
import CoordinateInfo from 'node/Graphic/info/CoordinateInfo';
import FillInfo from 'node/Graphic/info/FillInfo';
import PathInfo from 'node/Graphic/info/PathInfo';
import StrokeInfo from 'node/Graphic/info/StrokeInfo';
...
export default class GraphicModel extends TreeNode {
    ...
    public clone(): GraphicModel {
        const cloned = new GraphicModel(IdContainer.generateId());
        // graphic enum clone
