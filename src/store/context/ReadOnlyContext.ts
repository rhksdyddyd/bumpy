...
export interface IReadOnlyContextInitProp {
    handleCommandEventFunction: (props: CommandProps) => void;
}
...
export default class ReadOnlyContext {
     ...
     */
    private readonly handleCommandEvent: (props: CommandProps) => void;
     ...
     */
    @boundMethod
    public callHandleCommandEvent(props: CommandProps): void {
