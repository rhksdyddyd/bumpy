...
import SimpleCommand from 'command/simplecommand/SimpleCommand';
...
export default class CommandCompositor {
     ...
     */
    private oldEventState: EventState;

    /**
     * do, Redo 시의 EventState 정보입니다.
     */
    private newEventState: EventState;
     ...
     */
    @boundMethod
    public getOldEventState(): EventState {
     ...
     */
    @boundMethod
    public setOldEventState(eventState: EventState): void {
     ...
     */
    @boundMethod
    public getNewEventState(): EventState {
     ...
     */
    @boundMethod
    public setNewEventState(eventState: EventState): void {
    ...
    public applySimpleCommand(): void {
        for (let index = this.executalbeSimpleCommandIndex; index < this.simpleCommandList.length; index += 1) {
