...
import GraphicModelSelectionContainer from 'selection/graphic/GraphicModelSelectionContainer';
...
export default class SelectionContainer {
     ...
     */
    @boundMethod
    public forEachContainer(callback: (internalSelectionContainer: InternalSelectionContainer) => void): void {
